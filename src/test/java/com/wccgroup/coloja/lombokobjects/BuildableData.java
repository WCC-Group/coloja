...
@Data
@Builder
// Limitation: @Data + @Builder generates only the allargsconstructor, but for convenience we want both.
// Also see https://github.com/rzwitserloot/lombok/issues/816
@NoArgsConstructor
@AllArgsConstructor
